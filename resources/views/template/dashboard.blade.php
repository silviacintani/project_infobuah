            ...
            <ul class="nav nav-secondary">
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="components/avatars.html">
                        <span class="sub-item text-white">Avatars</span>
                      </a>
                    </li>
                    {{-- <li>
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#sidebarLayouts">
                  ...
                  <p class="text-white">Sidebar Layouts</p>
                  <span class="caret"></span>
                </a>
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="sidebar-style-2.html">
                        <span class="text-white">Sidebar Style 2</span>
                      </a>
                    </li>
                    <li>
                  ...
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="tables/tables.html">
                        <span class="sub-item text-white">Basic Table</span>
                      </a>
                    </li>
                    <li>
                      <a href="tables/datatables.html">
                        <span class="sub-item text-white">Datatables</span>
                      </a>
                    </li>
                  </ul>
                </div>
